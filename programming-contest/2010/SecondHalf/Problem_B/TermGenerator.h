...
class TermGenerator
{
    ...
    public: // public interfaces
        ...
        void clearSentenceScore() { rankedSentenceScore_.clear(); rankedSentenceId_.clear(); }
        void getTopSentenceId(std::list<ID_T>& topSentenceId) { topSentenceId = rankedSentenceId_; }
