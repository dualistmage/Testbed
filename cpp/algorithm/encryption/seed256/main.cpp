...
//		                  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
	BYTE pbData[32]    = {0x3c, 0xd1, 0x39, 0xe2, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 
...
// Print plaintext to be encrypted
	printf ("\nPlaintext  : ");
	for (i=0;i<32;i++)	{printf("%02X ",pbData[i]);}
	
// Derive roundkeys from user secret key
	SeedRoundKey(pdwRoundKey, pbUserKey);

    printf("\nROUNDKEY    : ");
    for (i=0;i<48;i++) printf("%x ", pdwRoundKey[i]);
    printf("\n");
